...
int main() {
	...
	if (CONNECT_SERVER) std::cout << (netClient.setup("192.168.1.18", hyacinthEngine.m_swImageFormat, hyacinthEngine.m_descriptorSetLayout, tickOffset) ? "CONNECTION FAILED" : "CONNECTION SUCCESSFUL") << std::endl;
	tickNum = tickOffset;
